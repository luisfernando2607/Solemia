<div x-data="{ prevCount: 0, tradeName: '{{ \App\Models\RestaurantSetting::current()->trade_name }}' }" x-init="$watch('$wire.pendingCount', val => { if(val > prevCount && prevCount > 0) { let s = new Audio; s.src = 'data:audio/wav;base64,'; s.play(); } prevCount = val; }); document.title = 'Cocina | ' + tradeName + ' POS'; $watch('$wire.pendingCount', val => { document.title = val > 0 ? `(${val}) Cocina | ${tradeName} POS` : 'Cocina | ' + tradeName + ' POS'; });" class="h-full flex flex-col">
    ...
    <div class="flex-1 overflow-y-auto" wire:poll.5s>
        ...
        @else
            @php $kdsAlert = \App\Models\RestaurantSetting::current()->kds_alert_minutes ?? 10; @endphp
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3">
                @foreach ($this->activeOrders as $order)
                    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden
                        {{ $order->items->contains(fn($i) => $i->kitchen_status === 'pending' && $i->created_at->diffInMinutes(now()) > $kdsAlert) ? 'ring-2 ring-red-300 animate-pulse' : '' }}
                        {{ $order->items->contains(fn($i) => $i->kitchen_status === 'pending' && $i->created_at->diffInMinutes(now()) > ($kdsAlert * 0.5)) ? 'ring-2 ring-yellow-300' : '' }}">
                        {{-- Card Header --}}
